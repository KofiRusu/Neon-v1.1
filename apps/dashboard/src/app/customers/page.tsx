...
export default function CustomersPage(): JSX.Element {
  ...
  const getSegmentColor = (segment: string) => {
    switch (segment) {
      case 'vip': return 'text-neon-gold';
      case 'loyal': return 'text-neon-green';
      case 'new': return 'text-neon-purple';
      case 'at-risk': return 'text-neon-orange';
    ...
    <div className="min-h-screen p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-secondary text-lg">360° customer insights and journey optimization</p>
          </div>
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className={`p-2 rounded-lg transition-colors ${
                  viewMode === 'grid' ? 'bg-neon-blue text-white' : 'text-secondary hover:text-neon-blue'
                }`}
              >
              ...
              <button
                ...
                className={`p-2 rounded-lg transition-colors ${
                  viewMode === 'list' ? 'bg-neon-blue text-white' : 'text-secondary hover:text-neon-blue'
                }`}
              >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredCustomers.map((customer) => (
          <div key={customer.id} className="card-neon group hover:scale-105 transition-all duration-300">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className={`text-xs font-medium uppercase tracking-wide ${getSegmentColor(customer.segment)}`}>
                    {customer.segment}
                  </p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                <div className={`w-2 h-2 rounded-full ${customer.status === 'active' ? 'bg-neon-green' : 'bg-neon-orange'} animate-pulse`}></div>
