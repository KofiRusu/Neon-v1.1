...
export default function AssetsPage(): JSX.Element {
  ...
  // Fetch assets
  const { data: assetsData, isLoading: assetsLoading, refetch: refetchAssets } = api.assets.getAssets.useQuery({
      ...
      >
        ...
        <div className="relative h-48 bg-gradient-to-br from-gray-800 to-gray-900 rounded-t-2xl overflow-hidden">
          ...
          <div className="absolute top-4 right-4">
            <div className={`p-2 rounded-lg bg-black/50 backdrop-blur-sm ${getStatusColor(asset.status)}`}>
          ...
          <div className="flex items-start justify-between mb-2">
            ...
            {asset.parent && (
              <div className="flex items-center text-xs text-neon-purple">
                ...
                v{asset.versions[0]?.version || '1.0'}
              </div>
            )}
          </div>
      ...
      <div className="glass-strong p-6 rounded-2xl">
              ...
              <div key={asset.id} className="glass p-4 rounded-xl">
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <span className={`px-2 py-1 rounded-full text-xs ${getStatusColor(asset.status)} bg-gray-800`}>
                      {asset.status}
                    </span>
        ...
        {(!assetsData?.assets || assetsData.assets.length === 0) && !assetsLoading && (
          <div className="text-center py-20">
            ...
            <p className="text-secondary mb-6">Start building your asset library by uploading your first creative asset.</p>
            <button 
              onClick={() => setShowUploadModal(true)}
              className="btn-neon"
            >
