...
export default function CoordinationPage(): JSX.Element {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'waiting': return 'text-neon-orange';
      case 'monitoring': return 'text-neon-purple';
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-secondary text-lg">Multi-agent workflow orchestration and task management</p>
          </div>
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className={`px-2 py-1 rounded-full text-xs font-medium ${
                    workflow.priority === 'high' ? 'bg-neon-pink text-black' :
                    workflow.priority === 'medium' ? 'bg-neon-orange text-black' :
        ...
        <div className="glass-strong p-6 rounded-2xl">
          ...
          <div className="space-y-4">
            ...
            <div className="glass p-4 rounded-xl">
              ...
              <p className="text-sm text-primary">AdAgent: Budget threshold reached, switching to optimization mode</p>
            </div>
          </div>
