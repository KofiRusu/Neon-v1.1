...
export default function TrainingPage(): JSX.Element {
  ...
  const performanceChartData = {
    labels: chartData?.chartData?.map(point => 
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              ...
              Filters
              {showFilters ? <ChevronDownIcon className="h-4 w-4 ml-2" /> : <ChevronRightIcon className="h-4 w-4 ml-2" />}
            </button>
        ...
        <div className="stat-card">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              ...
              <div className={`stat-number ${getScoreDeltaColor(statsData?.avgScoreImprovement || 0)}`}>
          ...
          <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-4">
                      {log.scoreDelta !== null && (
                        <div className={`font-semibold ${getScoreDeltaColor(log.scoreDelta)}`}>
                          {log.scoreDelta > 0 ? '+' : ''}{log.scoreDelta?.toFixed(2)}%
                        </div>
                      )}
                      ...
                      {log.scoreAfter !== null && (
                        <div className="text-right">
                          ...
                          <div className="font-semibold text-primary">{log.scoreAfter?.toFixed(1)}%</div>
                        </div>
                      )}
                      
                      {isExpanded ? <ChevronDownIcon className="h-5 w-5 text-secondary" /> : <ChevronRightIcon className="h-5 w-5 text-secondary" />}
                    </div>
                  </div>
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-600">
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <div className="font-medium text-primary">{log.modelVersion || 'N/A'}</div>
                        </div>
                        <div>
            ...
            {(!logsData?.logs || logsData.logs.length === 0) && (
              <div className="text-center py-12">
                ...
                <p className="text-secondary">Training events will appear here as agents learn and improve.</p>
              </div>
            )}
          </div>
        )}
