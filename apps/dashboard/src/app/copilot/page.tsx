  ...
  const messages = [
    {
      id: 1,
      type: 'system',
      content: 'NeonHub AI Copilot is ready to assist you. How can I help optimize your marketing campaigns today?',
                ...
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    className={`p-2 rounded-lg transition-colors ${
                      isListening ? 'bg-neon-blue text-white' : 'text-secondary hover:text-neon-blue'
                    }`}
                  >
