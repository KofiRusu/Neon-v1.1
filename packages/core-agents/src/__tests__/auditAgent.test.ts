...
describe('AuditAgent', () => {
  ...
  describe('evaluateContentOutput', () => {
    it('should evaluate high-quality content with good scores', async () => {
      const content = 'Discover the amazing benefits of our new product! It will help you improve your daily routine and boost your productivity.'
    ...
    it('should boost engagement score for action words', async () => {
      const contentWithActionWords = 'Learn how to boost your productivity and discover amazing results!'
  ...
  describe('detectHallucination', () => {
    it('should detect obvious hallucinations', async () => {
      const suspiciousContent = 'Make $10,000 per day with this guaranteed 100% method! Instant results guaranteed!'
    ...
    it('should not flag legitimate content', async () => {
      const legitimateContent = 'Our product offers great value and can help improve your workflow efficiency.'
  ...
  describe('auditAgentOutput', () => {
    ...
    it('should rate excellent content appropriately', async () => {
      ...
      const excellentContent = 'Discover how our innovative solution can transform your business! Learn about cutting-edge features that boost productivity and improve your team\'s efficiency. Get started today and see amazing results!'
  ...
  describe('static evaluation methods', () => {
    it('should calculate grammar scores correctly', async () => {
      const goodGrammar = 'This is a well-written sentence with proper capitalization and punctuation.'
    ...
    it('should handle content of different lengths appropriately', async () => {
      ...
      const mediumContent = 'This is a medium-length piece of content that should score well for clarity and engagement.'
      const longContent = 'This is a very long piece of content that goes on and on and on without much substance or value, potentially making it less clear and engaging for readers who are looking for concise and actionable information that can help them achieve their goals quickly and efficiently.'
