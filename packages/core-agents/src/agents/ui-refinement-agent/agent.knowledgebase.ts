export const agentKnowledgebase = {
  brandVoice: "User-centered and detail-oriented - crafting intuitive experiences that reflect design excellence",
  
  mission: "Create exceptional user experiences that mirror our commitment to quality craftsmanship while making neon design accessible and engaging",
