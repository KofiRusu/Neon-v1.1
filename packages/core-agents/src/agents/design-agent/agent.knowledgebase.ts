export const agentKnowledgebase = {
  ...
  mission: "Create visually stunning and functionally effective neon designs that capture brand essence while meeting technical requirements and customer vision",
  ...
  designPhilosophy: {
    ...
    approach: "Collaborative design process that educates and inspires while delivering practical solutions"
  },
  ...
  products: [
    {
      ...
      designApproach: {
        ...
        considerations: ["Viewing distance", "Ambient lighting", "Building architecture", "Local regulations"],
    ...
    },
    {
      ...
      designApproach: {
        ...
        considerations: ["Event duration", "Indoor/outdoor use", "Power accessibility", "Setup requirements"],
    ...
    },
    {
      category: "Home Décor",
      designApproach: {
        priorities: ["Personal expression", "Mood lighting", "Interior harmony", "Conversation pieces"],
        aesthetics: "Personalized, lifestyle-focused - balancing statement piece with home integration",
        considerations: ["Room aesthetics", "Lighting integration", "Size constraints", "Power requirements"],
  ...
  designProcess: {
    ...
    refinement: {
      feedback: "Collaborative revision process incorporating client input and technical optimization",
  ...
  designSpecialties: {
    typography: {
      ...
      considerations: ["Viewing distance", "Lighting conditions", "Brand consistency", "Technical feasibility"],
    ...
    iconography: {
      ...
      considerations: ["Cultural relevance", "Scalability", "Technical constraints", "Brand alignment"],
      innovation: "Abstract and literal interpretations that capture essence while embracing neon medium"
    },
    
    environmental: {
      expertise: "Architectural integration, spatial relationships, environmental harmony",
      considerations: ["Scale relationships", "Viewing angles", "Ambient lighting", "Regulatory compliance"],
    ...
    interactive: {
      ...
      considerations: ["Technical complexity", "Maintenance requirements", "User experience", "Cost implications"],
  ...
  qualityStandards: {
    ...
    innovation: "Each project should push creative boundaries while respecting practical constraints"
  },
  
  clientCollaboration: {
    communication: "Clear, visual communication that makes design concepts accessible to all stakeholders",
    education: "Help clients understand design rationale, technical requirements, and maintenance needs",
    flexibility: "Adaptable design process that accommodates changing requirements and budget constraints",
