export const agentKnowledgebase = {
  brandVoice: "Creative, Professional, Energetic - with emphasis on storytelling and educational value",
  
  mission: "Create compelling, educational, and engaging content that showcases our neon signage expertise while inspiring customers to transform their spaces",
  ...
  contentStrategy: {
    ...
    contentPillars: {
      education: {
        weight: 30,
        topics: ["LED technology benefits", "Installation guides", "Maintenance tips", "Design principles"],
        tone: "Expert but accessible, helpful and informative"
      },
      inspiration: {
        weight: 25,
        topics: ["Design trends", "Color psychology", "Space transformation", "Creative applications"],
        tone: "Enthusiastic, creative, aspirational"
      },
      craftsmanship: {
        weight: 25,
        topics: ["Manufacturing process", "Quality standards", "Artist profiles", "Technique spotlights"],
  ...
  products: [
    {
      ...
      contentFocus: "ROI stories, visibility improvement, professional appearance, customer acquisition impact",
      keyMessaging: "Transform your business presence with signs that work as hard as you do"
    },
    {
      category: "Event Signage",
      contentFocus: "Memorable moments, photo opportunities, personal celebrations, unique experiences", 
  ...
  contentTypes: {
    ...
    email: {
      topics: ["New product announcements", "Seasonal promotions", "Design contests", "Maintenance tips"],
    ...
    video: {
      topics: ["Time-lapse creation", "Installation process", "Customer interviews", "Design tutorials"],
      tone: "Dynamic and engaging, showcasing the artistry and technical skill",
      formats: ["Process documentation", "Educational tutorials", "Customer testimonials", "Design showcases"]
    }
  },
  
  messagingFramework: {
    problemAware: "Many businesses struggle with generic signage that fails to capture attention or reflect their unique brand",
    solutionIntro: "Custom neon signage offers unlimited creative possibilities with modern LED efficiency",
    valueProposition: "Professional craftsmanship meets innovative technology to create signs that work as marketing investments",
    credibilityIndicators: ["48-hour rush capability", "Lifetime LED warranty", "Local manufacturing", "Free design consultation"],
    callToActionTemplates: ["Get your free design consultation", "See how we can transform your space", "Discover your custom solution"]
  },
  
  editorialGuidelines: {
    headlines: "Benefit-focused with creative flair (e.g., 'How Custom Neon Transformed This Restaurant's Evening Revenue')",
