export const agentKnowledgebase = {
  brandVoice: "Data-driven and analytical - translating complex metrics into actionable business insights",
  
  mission: "Transform raw data into strategic insights that drive business growth and optimize neon signage performance across all customer touchpoints",
  
  analyticsFramework: {
    businessIntelligence: {
      focus: "Revenue optimization, customer lifetime value, and growth opportunities",
      metrics: ["Revenue per customer", "Customer acquisition cost", "Lifetime value", "Repeat purchase rate"],
    ...
    customerJourney: {
      ...
      metrics: ["Conversion rates by channel", "Time to purchase", "Touchpoint effectiveness", "Customer satisfaction scores"],
    ...
    marketingROI: {
      ...
      metrics: ["Cost per acquisition", "Revenue attribution", "Channel performance", "Campaign effectiveness"],
  ...
  products: [
    {
      ...
      analyticsApproach: {
        keyMetrics: ["Revenue per sign", "Customer acquisition impact", "Repeat business rate", "Referral generation"],
        performance: "Track business outcome metrics for customers to demonstrate ROI",
        insights: "Identify which business types see the highest value and target similar prospects",
    ...
    },
    {
      ...
      analyticsApproach: {
        keyMetrics: ["Seasonal demand patterns", "Event type popularity", "Social media engagement", "Repeat event usage"],
    ...
    },
    {
      category: "Home Décor",
      analyticsApproach: {
        keyMetrics: ["Lifestyle segment preferences", "Design trend adoption", "Smart feature usage", "Customer satisfaction"],
  ...
  dataSourcesAndMetrics: {
    salesData: {
      ...
      metrics: ["Revenue", "Order volume", "Average order value", "Conversion rates", "Customer lifetime value"],
      insights: "Revenue trends, customer value segments, product performance"
    },
    
    marketingData: {
      sources: ["Google Analytics", "Social media platforms", "Email marketing", "Advertising platforms"],
      metrics: ["Traffic sources", "Engagement rates", "Conversion funnels", "Cost per acquisition", "Return on ad spend"],
    ...
    customerData: {
      ...
      metrics: ["Satisfaction scores", "Net Promoter Score", "Support resolution times", "Review ratings"],
      insights: "Customer satisfaction trends, product quality feedback, service improvement opportunities"
    },
    
    operationalData: {
      sources: ["Manufacturing systems", "Installation tracking", "Inventory management", "Staff scheduling"],
      metrics: ["Production efficiency", "Installation times", "Inventory turnover", "Staff utilization"],
  ...
  reportingAndDashboards: {
    ...
    marketingDashboard: {
      ...
      metrics: ["Campaign performance", "Channel effectiveness", "Content engagement", "Lead quality"],
  ...
  predictiveAnalytics: {
    demandForecasting: {
      ...
      outputs: ["Demand forecasts", "Inventory recommendations", "Staffing needs", "Production planning"],
    ...
    customerSegmentation: {
      ...
      outputs: ["Customer segments", "Lifetime value predictions", "Churn risk scores", "Personalization strategies"],
    ...
    pricingOptimization: {
      ...
      inputs: ["Competitive pricing", "Customer price sensitivity", "Cost structures", "Demand elasticity"],
      outputs: ["Pricing recommendations", "Revenue optimization", "Competitive positioning", "Margin improvement"],
  ...
  dataVisualization: {
    ...
    accessibility: "Ensure visualizations are accessible to all stakeholders regardless of technical expertise",
  ...
  continuousImprovement: {
    ...
    training: "Provide training and support to help stakeholders understand and use insights effectively"
  }
};