export const agentKnowledgebase = {
  brandVoice: "Compelling and results-driven - emphasizing transformation and competitive advantage",
  
  mission: "Drive qualified leads and conversions through strategic paid advertising that showcases our neon expertise and delivers measurable business results",
  ...
  products: [
    {
      ...
      adMessaging: {
        ...
        description: "Professional neon signage that makes your business impossible to ignore. Free consultation + 48-hour rush available.",
        valueProps: ["Attract more customers", "Stand out from competition", "Professional appearance", "Energy-efficient LED"],
    ...
    },
    {
      ...
      adMessaging: {
        ...
        description: "Personalized event signage that makes every celebration unforgettable. Perfect for weddings, parties & corporate events.",
        valueProps: ["Memorable photo opportunities", "Personalized celebrations", "Unique experiences", "Social media worthy"],
    ...
    },
    {
      ...
      adMessaging: {
        ...
        description: "Express your unique style with personalized neon that brings energy and personality to any room.",
        valueProps: ["Express personality", "Mood lighting", "Conversation starters", "Custom designs"],
  ...
  targetAudiences: {
    businessOwners: {
      ...
      painPoints: ["Low visibility", "Competition", "Generic appearance", "Customer acquisition costs"],
      motivations: ["Stand out", "Attract customers", "Professional image", "Marketing ROI"],
      messaging: "Transform your business presence and attract 40% more customers with professional custom neon signage"
    },
    ...
    eventPlanners: {
      ...
      painPoints: ["Generic decorations", "Memorable experiences", "Photo opportunities", "Client satisfaction"],
      motivations: ["Unique events", "Social sharing", "Client happiness", "Professional reputation"],
      messaging: "Create unforgettable, Instagram-worthy events that guests will remember and share"
    },
    ...
    homeowners: {
      ...
      motivations: ["Personal expression", "Unique style", "Home improvement", "Conversation pieces"],
  ...
  adFormats: {
    ...
    videoAds: {
      concepts: ["Time-lapse creation process", "Business transformation stories", "Before/after reveals"],
  ...
  keywordStrategy: {
    primary: {
      business: ["custom business signs", "neon business signs", "LED storefront signs", "commercial signage"],
      event: ["custom wedding signs", "event signage", "neon party decorations", "personalized event signs"],
    ...
    negative: [
      "free", "cheap", "diy", "rental", "temporary", "used"
    ]
  },
  ...
  landingPageStrategy: {
    businessSigns: {
      ...
      subheadline: "Transform your storefront with energy-efficient LED neon. Free consultation + 48-hour rush available.",
    ...
    eventSigns: {
      ...
      subheadline: "Personalized event signage for weddings, parties & celebrations. Make every moment unforgettable.",
    ...
    homeDecor: {
      headline: "Transform Your Space With Custom Neon Art",
      subheadline: "Express your unique style with personalized neon. Energy-efficient, app-controlled, unlimited customization.",
