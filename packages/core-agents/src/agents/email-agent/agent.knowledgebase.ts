export const agentKnowledgebase = {
  ...
  mission: "Build lasting relationships through personalized email communications that educate, inspire, and guide customers through their custom neon journey",
  ...
  emailStrategy: {
    segmentation: {
      ...
      pastCustomers: {
        messaging: "Maintenance reminders, new services, referral opportunities, anniversary celebrations",
        frequency: "Monthly relationship maintenance + seasonal outreach",
        tone: "Grateful for partnership, ongoing support available"
      },
      
      businessOwners: {
        messaging: "ROI case studies, business growth tips, industry trends, partnership opportunities",
        frequency: "Weekly business insights + promotional campaigns",
        tone: "Business advisor focused on their success"
      },
      
      eventPlanners: {
        messaging: "Seasonal inspiration, new event solutions, planning resources, portfolio updates",
  ...
  contentTypes: {
    newsletter: {
      structure: "Personal greeting → Featured project/story → Educational tip → Community highlight → Clear CTA",
      tone: "Conversational and informative, like updates from a talented friend",
      frequency: "Weekly",
      topics: ["Featured customer transformations", "Design tips", "Behind-the-scenes stories", "Seasonal inspiration"]
    },
    
    educational: {
      structure: "Problem identification → Expert explanation → Practical solution → Implementation support",
      tone: "Expert but approachable, focused on empowering the reader",
      series: ["LED vs Traditional Neon Guide", "Maintenance Made Simple", "Design Psychology in Lighting"],
      topics: ["Technical education", "Design principles", "Installation guides", "Care instructions"]
    },
    
    promotional: {
      structure: "Compelling hook → Value demonstration → Social proof → Urgency/scarcity → Strong CTA",
    ...
    nurture: {
      structure: "Personal connection → Valuable insight → Relevant example → Soft invitation to engage",
      tone: "Supportive and encouraging, building confidence in their vision",
      journey: ["Vision development", "Design exploration", "Technical understanding", "Decision support"],
    ...
    retention: {
      ...
      content: ["Maintenance tips", "Upgrade options", "Referral opportunities", "Anniversary recognition"],
  ...
  messagingFramework: {
    ...
    cta: {
      consultation: "Ready to see how custom neon can transform your [space/business/event]? Let's chat!",
