export const agentKnowledgebase = {
  brandVoice: "Forward-thinking and insightful - translating market signals into strategic opportunities",
  
  mission: "Identify and analyze emerging trends in design, technology, and customer behavior to keep our neon signage business ahead of market developments",
  
  trendAnalysisFramework: {
    designTrends: {
      focus: "Visual aesthetics, color preferences, typography, and artistic movements",
      sources: ["Design publications", "Social media", "Art exhibitions", "Fashion industry", "Architecture"],
      analysis: "Identify emerging design elements that could influence neon signage aesthetics",
      application: "Translate design trends into neon-appropriate applications and customer offerings"
    },
    
    technologyTrends: {
      focus: "LED innovations, smart controls, IoT integration, and manufacturing advances",
      sources: ["Tech publications", "Industry reports", "Patent filings", "Startup ecosystem", "Trade shows"],
      analysis: "Evaluate new technologies for potential integration into our offerings",
      application: "Assess feasibility, cost implications, and market readiness for new technologies"
    },
    
    consumerTrends: {
      focus: "Lifestyle changes, preferences, buying behaviors, and cultural shifts",
      sources: ["Consumer research", "Social media analytics", "Market surveys", "Demographic studies"],
    ...
    industryTrends: {
      ...
      sources: ["Industry publications", "Trade associations", "Regulatory bodies", "Competitor analysis"],
      analysis: "Track industry-specific developments and regulatory impacts",
      application: "Position our business to capitalize on industry changes and compliance requirements"
    }
  },
  ...
  products: [
    {
      ...
      trendTracking: {
        designElements: ["Minimalist aesthetics", "Retro revival", "Bold typography", "Architectural integration"],
        technology: ["Smart controls", "Energy efficiency", "Interactive features", "Modular systems"],
        applications: ["Sustainability messaging", "Digital integration", "Multi-language support", "Accessibility features"],
        market: "Business signage increasingly expected to be both functional and artistic statement pieces"
      }
    },
    {
      category: "Event Signage",
      trendTracking: {
        designElements: ["Instagram-worthy backdrops", "Personalization", "Themed aesthetics", "Color psychology"],
        technology: ["Portable solutions", "Quick setup", "Smart lighting", "Social media integration"],
        applications: ["Experiential marketing", "Photo opportunities", "Brand storytelling", "Cultural celebrations"],
    ...
    },
    {
      category: "Home Décor",
      trendTracking: {
        designElements: ["Wellness-focused lighting", "Biophilic design", "Maximalist expression", "Nostalgic elements"],
        technology: ["Smart home integration", "Circadian lighting", "Voice control", "Energy monitoring"],
        applications: ["Mental health awareness", "Remote work spaces", "Personalized environments", "Sustainable living"],
  ...
  trendSources: {
    designInspiration: {
      ...
      social: ["Instagram design accounts", "Pinterest boards", "TikTok creators", "YouTube channels"],
    ...
    technologyInnovation: {
      ...
      research: ["University research", "Patent databases", "R&D publications", "Industry whitepapers"],
    ...
    industryIntelligence: {
      publications: ["Signs of the Times", "Sign Builder Illustrated", "ISA Sign Expo", "Architectural SSL"],
      associations: ["International Sign Association", "LED Association", "Lighting Industry Association"],
  ...
  trendImpactAssessment: {
    ...
    technicalFeasibility: {
      factors: ["Manufacturing complexity", "Supply chain availability", "Quality standards", "Cost implications"],
    ...
    competitiveAdvantage: {
      factors: ["Differentiation potential", "Barrier to entry", "Market leadership opportunity", "Competitive response"],
    ...
    brandAlignment: {
      factors: ["Brand consistency", "Value proposition fit", "Customer expectation alignment", "Marketing synergy"],
  ...
  trendReporting: {
    ...
    annual: {
      ...
      content: "Long-term trend analysis, strategic positioning recommendations, investment priorities"
    },
  ...
  trendsToWatch: {
    sustainability: {
      ...
      implications: "Eco-friendly product development, sustainability messaging, green manufacturing",
    ...
    personalization: {
      ...
      implications: "Enhanced customization capabilities, personalized marketing, bespoke offerings",
