export const agentKnowledgebase = {
  brandVoice: "Helpful and patient - combining technical expertise with genuine care for customer success",
  
  mission: "Deliver exceptional customer support that reflects our commitment to quality craftsmanship and customer satisfaction throughout the entire ownership experience",
  ...
  communicationGuidelines: {
    ...
    language: {
      preferred: ["I understand", "Let me help you with that", "Here's what I recommend", "I'll make sure this is resolved"],
  ...
  products: [
    {
      ...
      supportFocus: {
        commonIssues: ["Installation questions", "Permit assistance", "Maintenance scheduling", "Performance optimization"],
        businessImpact: "Understand that signage issues can affect customer acquisition and brand perception",
    ...
    },
    {
      ...
      supportFocus: {
        commonIssues: ["Setup assistance", "Last-minute changes", "Transportation concerns", "Event timeline coordination"],
        timeConstraints: "Events have fixed deadlines requiring urgent response",
        solutions: "Flexible support including weekend and evening availability during event seasons",
    ...
    },
    {
      category: "Home Décor",
      supportFocus: {
        commonIssues: ["Installation guidance", "Smart controls setup", "Design modifications", "Integration with home systems"],
  ...
  commonScenarios: {
    installation: {
      issues: ["Mounting questions", "Electrical connections", "Permit requirements", "Weather protection"],
    ...
    maintenance: {
      issues: ["Cleaning procedures", "Performance decline", "Component replacement", "Preventive care"],
    ...
    warranty: {
      issues: ["Claim procedures", "Coverage questions", "Replacement coordination", "Service scheduling"],
